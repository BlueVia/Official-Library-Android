package com.bluevia.android.commons.connector.http;
...
import com.bluevia.android.commons.connector.IAuth;
...
import com.bluevia.android.commons.connector.http.multipart.MultipartEntity;
...
public class HttpConnector implements IConnector, IAuth {
	...
	private HttpEntity createHttpEntity(byte[] body, HashMap<String, String> headers) throws IOException, ParseException {
		...
		if (body != null && Log.isLoggable(TAG, Log.DEBUG)) {
			try {
				Log.d(TAG, "Serialized entry: " + new String(body, "UTF-8"));
	...
	private class CurlLogger implements HttpRequestInterceptor {
		...
		public void process(HttpRequest request, HttpContext context)
			...
			Log.i(TAG, toCurl((HttpUriRequest) request, true));
		}
	}
