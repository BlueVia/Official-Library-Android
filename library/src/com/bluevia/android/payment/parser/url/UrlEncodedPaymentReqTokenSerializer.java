/**
 * @package com.bluevia.android.payment.parser.url This package contains the classes in order to serialize and parse URL encoded data for Payment API.
 */
package com.bluevia.android.payment.parser.url;
