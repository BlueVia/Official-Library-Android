package com.bluevia.android.commons;
...
public class Utils {
	...
	public static boolean isPhoneNumber(String value){
		...
		Log.d(TAG, "Starting isPhoneNumber " + value);
		if (value != null) {
			...
			if(matcher.matches()){
				...
				Log.e (TAG, "Phone Number Address " + value + " does not follow phone pattern");
			}
		} else {
			Log.e (TAG,"Phone Number Address must not be null");
		}
		Log.d(TAG, "isPhoneNumber: " + isValid);
		return isValid;
	}
