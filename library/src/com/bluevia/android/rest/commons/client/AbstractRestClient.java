...
public abstract class AbstractRestClient {
	 ...
	 * <ul>
	 *   <li>HTTP_LIVE: Connects with the endpoint of the server in Live environment</li>
	 *   <li>HTTP_SANDBOX: Connects with the endpoint of the server in Sandbox environment</li>
	 ...
	 * 
	 */
	public static enum Mode {HTTP, HTTP_SANDBOX, TEST_OK, TEST_UNAUTHORIZED, TEST_ERROR_IOEXCEPTION, TEST_ERROR_HTTPEXCEPTION}
